...
export default function SearchBar() {
  ...
  return (
    <form onSubmit={(e) => searchInTours(e) } className="w-full h-56  flex items-center justify-center absolute text-orange-500 ">
      <div className="shadow-lg w-2/3 p-6 flex flex-wrap sm:flex-nowrap sm:space-x-2 bg-orange-400 rounded-lg relative -top-5 sm:-top-20 z-10">
        ...
        <div className="col-span-6 sm:col-span-3 lg:col-span-2 w-full sm:w-1/4 flex flex-col-reverse sm:mt-0 mt-5 ">
          <button type='submit' className='  bg-white w-full font-bold text-2xl p-1 rounded-lg transition hover:bg-orange-400 hover:border-2 hover:boder-white hover:text-white'>Keresés</button>
        </div>
      </div>
    </form>
  );
